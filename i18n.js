(function () {
  const dictionaries = {
    ...
    support: {
      ...
      "faq.q1": { en: "Can I use it without login?", ko: "로그인 없이도 사용할 수 있나요?", ja: "ログインなしで使えますか？", zh: "不登录也可以使用吗？" },
      "faq.a1": { en: "Yes. Local features work without login, and Google integration is optional.", ko: "네. 로컬 기능은 로그인 없이 사용 가능하며 Google 연동은 선택 기능입니다.", ja: "はい。ローカル機能はログイン不要で、Google 連携は任意です。", zh: "可以。本地功能无需登录，Google 集成是可选项。" },
